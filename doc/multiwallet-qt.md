...
In order to support loading of multiple wallets in searchpaycoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is searchpaycoin.cpp.
...
Changes to searchpaycoin.cpp
----------------------
searchpaycoin.cpp is the entry point into searchpaycoin-qt, and as such, will require some minor modifications to provide hooks for
