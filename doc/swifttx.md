...
This mechanism has been integrated into Bitcore-Node-SearchPayCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/SearchPayCoin-Project/insight-api-searchpaycoin#web-socket-api](https://github.com/SearchPayCoin-Project/insight-api-searchpaycoin#web-socket-api) 
* API: [https://github.com/SearchPayCoin-Project/insight-api-searchpaycoin#swifttx-transactions](https://github.com/SearchPayCoin-Project/insight-api-searchpaycoin#swifttx-transactions) 
...
By default, the SearchPayCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SearchPayCoin Core daemon:
