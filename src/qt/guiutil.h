...
/** Utility functions used by the SearchPayCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render SearchPayCoin addresses in monospace font
...
// Parse "searchpaycoin:" URI into recipient object, return true on successful parsing
