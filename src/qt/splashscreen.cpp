...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("SearchPayCoin Core");
    QString versionText = QString(tr("Version v1.0.0.0")).arg(QString::fromStdString(FormatFullVersion()));
	...
	QString copyrightTextSepy = QChar(0xA9) + QString(tr(" 2018 The SearchPayCoin Core developers"));
	...
	pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 48, copyrightTextSepy);
