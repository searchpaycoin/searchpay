...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SearchPayCoin Core"),
     ...
     * override -datadir in the searchpaycoin.conf file in the default data directory
     * (to be consistent with searchpaycoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
