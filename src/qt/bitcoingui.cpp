                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SearchPayCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SearchPayCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and searchpaycoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SearchPayCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about SearchPayCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SearchPayCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SearchPayCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SearchPayCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a SearchPayCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SearchPayCoin Core help message to get a list with possible SearchPayCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SearchPayCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SearchPayCoin network", "", count));
}
...
{
    QString strTitle = tr("SearchPayCoin Core"); // default title
