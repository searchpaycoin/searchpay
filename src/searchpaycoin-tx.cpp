...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SearchPayCoin Core searchpaycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  searchpaycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded searchpaycoin transaction") + "\n" +
                               "  searchpaycoin-tx [options] -create [commands]   " + _("Create hex-encoded searchpaycoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded searchpaycoin transaction
