...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop SearchPayCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "SearchPayCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SearchPayCoin features */
        {"searchpaycoin", "masternode", &masternode, true, true, false},
        {"searchpaycoin", "listmasternodes", &listmasternodes, true, true, false},
        {"searchpaycoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"searchpaycoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"searchpaycoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"searchpaycoin", "masternodedebug", &masternodedebug, true, true, false},
        {"searchpaycoin", "startmasternode", &startmasternode, true, true, false},
        {"searchpaycoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"searchpaycoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"searchpaycoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"searchpaycoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"searchpaycoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"searchpaycoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"searchpaycoin", "mnbudget", &mnbudget, true, true, false},
        {"searchpaycoin", "preparebudget", &preparebudget, true, true, false},
        {"searchpaycoin", "submitbudget", &submitbudget, true, true, false},
        {"searchpaycoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"searchpaycoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"searchpaycoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"searchpaycoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"searchpaycoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"searchpaycoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"searchpaycoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"searchpaycoin", "checkbudgets", &checkbudgets, true, true, false},
        {"searchpaycoin", "mnsync", &mnsync, true, true, false},
        {"searchpaycoin", "spork", &spork, true, true, false},
        {"searchpaycoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"searchpaycoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use searchpaycoind, or the -server option to searchpaycoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> searchpaycoin-cli " + methodname + " " + args + "\n";
}
